...
serve(async (req) => {
  ...
  try {
    console.log('🎯 NEW ROBOKASSA PAYMENT FUNCTION STARTED - v2.0');
    ...
    console.log('🔑 NEW FUNCTION - Environment variables check:', {
      ...
      rawMerchantLogin: Deno.env.get('ROBOKASSA_MERCHANT_LOGIN')
    });
    ...
    console.log('🔐 NEW FUNCTION - Signature generation:', {
    ...
    console.log('✅ NEW FUNCTION - Payment parameters prepared:', {
      merchantLogin,
      outSum: amountStr,
      invoiceId,
