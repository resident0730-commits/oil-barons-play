        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-3 flex-shrink-0">
            ...
            >
              ...
              <Wallet className="h-3.5 w-3.5 sm:h-5 sm:w-5 text-primary mr-1 sm:mr-2 transition-transform duration-300 group-hover:scale-110 flex-shrink-0" />
              <span className="font-bold text-xs sm:text-base relative z-10 whitespace-nowrap">{formatOilCoins(profile.oilcoin_balance)}</span>
            ...
            >
              ...
              <span className="text-oil-amber mr-1 sm:mr-2 transition-transform duration-300 group-hover:scale-110 text-base sm:text-lg flex-shrink-0">🛢️</span>
              <span className="font-bold text-xs sm:text-base relative z-10 whitespace-nowrap">{formatBarrels(profile.barrel_balance)}</span>
            ...
            >
              ...
              <span className="text-oil-gold mr-1 sm:mr-2 transition-transform duration-300 group-hover:scale-110 text-sm sm:text-base flex-shrink-0">₽</span>
              <span className="font-bold text-xs sm:text-base relative z-10 whitespace-nowrap">{formatRubles(profile.ruble_balance)}</span>
