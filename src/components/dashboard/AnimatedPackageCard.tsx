        ...
        >
          ...
          <CardContent className="p-3 sm:p-4 md:p-5 space-y-3 sm:space-y-4">
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-3 space-y-2">
              <p className="text-xs font-medium text-green-600">Совет:</p>
              <p className="text-xs text-muted-foreground leading-relaxed">
                {wellPackage.name === 'Стартовый пакет' && 'Лучший выбор для новичка! Экономия 24% и моментальный старт дохода. Прокачивайте скважины равномерно для стабильного роста.'}
                {wellPackage.name === 'Пакет роста' && 'Идеален для перехода на новый уровень! Промышленная скважина даст основной доход, а остальные — стабильную базу.'}
                {wellPackage.name === 'Бизнес пакет' && 'Профессиональный выбор! Активируйте бустер "Автоматизация" сразу после покупки — эффект умножится на все 6 скважин!'}
                {wellPackage.name === 'Империя пакет' && 'Максимальная экономия 25%! Элитные скважины быстро окупятся. Приоритет прокачки — Легендарная скважина для максимального дохода.'}
              </p>
            </div>
