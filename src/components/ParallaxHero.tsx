        ...
        <div className="text-center space-y-16 animate-fade-in">
          ...
          <div className="space-y-10">
            ...
            <div className="max-w-5xl mx-auto space-y-8">
              <p className="text-5xl md:text-7xl lg:text-8xl font-bold leading-tight text-white [text-shadow:_3px_3px_6px_rgb(0_0_0_/_90%),_-2px_-2px_4px_rgb(0_0_0_/_70%),_0_0_40px_rgba(255,255,255,0.3)]">
                От первой капли нефти до нефтяной империи
              </p>
              
              <p className="text-3xl md:text-5xl lg:text-6xl font-semibold max-w-4xl mx-auto leading-relaxed text-white [text-shadow:_2px_2px_5px_rgb(0_0_0_/_85%),_-1px_-1px_3px_rgb(0_0_0_/_65%),_0_0_30px_rgba(234,179,8,0.4)]">
