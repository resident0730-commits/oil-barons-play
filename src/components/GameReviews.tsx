...
const generateReviews = (): GameReview[] => {
  const nicknames = [
    "OilKing2024", "Нефтяник_Pro", "DrillMaster", "PetrolBaron", "EnergyTycoon",
    "BlackGoldHunter", "OilEmpire", "DrillExpert", "FuelMagnate", "PipelinePro",
    "CrudeOilBoss", "RefinerElite", "BarrelCollector", "WellDigger", "OilRusher",
    "PetroChampion", "EnergyMogul", "DrillKing", "OilShark", "FuelTitan"
  ];
  ...
  const reviewTexts = [
    ...
    "За месяц игры вывел около 2к. Не миллионы конечно, но на кофе хватает.",
    ...
    "Скучновато играть одному, хотелось бы больше социальных функций.",
        ...
        <div className="text-center">
          ...
          >
            {showAll ? (
              ...
              <>
                <MessageSquare className="h-4 w-4" />
                Показать все отзывы ({reviews.length - 3} еще)
              </>
            )}
          </Button>
        </div>
