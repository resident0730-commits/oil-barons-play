              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                      <li><strong>Пользователь должен хотя бы один раз совершить покупку игровой валюты</strong></li>
                    ...
                    <p className="text-muted-foreground mt-2 italic">
                      ...
                      игровой валюты. Данное требование введено для предотвращения мошенничества и обеспечения 
