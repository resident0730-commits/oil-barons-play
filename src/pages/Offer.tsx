          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-sm">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Поскольку все игровые активы являются виртуальными и сервис предоставляется 
                  бесплатно, возврат денежных средств не предусмотрен. Все внутриигровые 
                  покупки осуществляются за виртуальную валюту.
                </p>
              </div>
