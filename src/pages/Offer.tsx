              ...
              <div>
                ...
                <div className="mt-4">
                  ...
                  <p className="text-muted-foreground mb-2">
                    Сервис Oil Tycoon работает в режиме закрытой регистрации. Это означает:
                  </p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                    <li><strong>Регистрация возможна только по реферальному коду</strong> - для создания аккаунта необходимо получить действующий реферальный код от существующего пользователя</li>
                    <li>Реферальный код является обязательным полем при регистрации</li>
                    <li>Регистрация без указания реферального кода невозможна</li>
                    <li>Администрация оставляет за собой право изменять условия доступа к регистрации</li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                      <li><strong>Пользователь должен хотя бы один раз совершить покупку игровой валюты или игровых активов</strong></li>
                      <li>Минимальная сумма вывода составляет 10000 рублей</li>
                    ...
                    <p className="text-muted-foreground mt-2 italic">
                      Важно: Функция вывода средств доступна только игрокам, которые совершили хотя бы одну покупку 
                      игровой валюты или игровых активов. Данное требование введено для предотвращения мошенничества 
                      и обеспечения безопасности платежной системы.
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    <h4 className="font-medium mb-2">8.4. Налогообложение</h4>
                    <p className="text-muted-foreground mb-2">
                      Пользователь самостоятельно несёт ответственность за уплату всех применимых 
                      налогов, сборов и иных обязательных платежей, связанных с получением дохода 
                      от использования игрового сервиса, в соответствии с законодательством 
                      Российской Федерации или иной юрисдикции, резидентом которой является Пользователь.
                    </p>
                    <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                      <li>Администрация не является налоговым агентом и не удерживает налоги с выплат</li>
                      <li>Пользователь обязан самостоятельно декларировать полученный доход</li>
                      <li>Пользователь обязан уплачивать налог на доход физических лиц (НДФЛ) или иные применимые налоги</li>
                      <li>Ответственность за неуплату или несвоевременную уплату налогов несёт исключительно Пользователь</li>
                    </ul>
                    <p className="text-muted-foreground mt-2 italic">
                      Администрация рекомендует обратиться к квалифицированному налоговому консультанту 
                      для получения информации о налоговых обязательствах в вашей юрисдикции.
                    </p>
                  </div>
                </div>
              </div>
