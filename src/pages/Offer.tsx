              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
                      <li><strong>Пользователь должен хотя бы один раз пополнить игровой счет реальными денежными средствами</strong></li>
                    ...
                    <p className="text-muted-foreground mt-2 italic">
                      Важно: Функция вывода средств доступна только игрокам, которые осуществили реальное пополнение 
                      игрового баланса. Данное требование введено для предотвращения мошенничества и обеспечения 
