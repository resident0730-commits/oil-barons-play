    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Минимальная сумма вывода составляет 10 000 рублей. Комиссия на вывод отсутствует."
        },
        {
          q: "Сколько времени занимает вывод?",
          a: "Стандартный срок обработки заявки — 1-3 рабочих дня. При необходимости дополнительной верификации срок может быть увеличен до 7 дней."
        },
        {
